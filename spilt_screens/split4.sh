...
readonly SLOT_COUNT=4
readonly GRID_COLS=2
readonly GRID_ROWS=2
readonly INNER_SEAM_OVERLAP_X=12
readonly INNER_SEAM_OVERLAP_Y=12
readonly STATE_DIR="${XDG_CACHE_HOME:-$HOME/.cache}/split4"
...
usage() {
  cat <<'EOF'
Usage: split4.sh [--daemon|--status|--stop] [--dry-run] [--verbose] [--help]

Arrange windows into a fixed 2x2 grid on the current monitor's usable work area.
